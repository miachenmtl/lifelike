...
var conway = require("../app/lifelike-logic");
...
describe("Count Neighborhood", function() {
  ...
  it("counts the number of cells alive in the Moore neighborhood of top left corner", function() {
    count[0] = conway.countNeighborhood(lifeAtRowCol, 0, 0);
    expect(count[0]).to.equal(0);
  });
  it("counts the number of cells alive in the Moore neighborhood along top edge", function() {
    count[0] = conway.countNeighborhood(lifeAtRowCol, 0, 1);
    count[1] = conway.countNeighborhood(lifeAtRowCol, 0, 2);
    count[2] = conway.countNeighborhood(lifeAtRowCol, 0, 3);
    count[3] = conway.countNeighborhood(lifeAtRowCol, 0, 4);
  ...
  it("counts the number of cells alive in the Moore neighborhood along left edge", function() {
    count[0] = conway.countNeighborhood(lifeAtRowCol, 1, 0);
    count[1] = conway.countNeighborhood(lifeAtRowCol, 2, 0);
    count[2] = conway.countNeighborhood(lifeAtRowCol, 3, 0);
    count[3] = conway.countNeighborhood(lifeAtRowCol, 4, 0);
    expect(count[0]).to.equal(2);
    expect(count[1]).to.equal(1);
  ...
  it("counts the number of cells alive in the Moore neighborhood in the middle", function() {
    count[0] = conway.countNeighborhood(lifeAtRowCol, 1, 1);
    count[1] = conway.countNeighborhood(lifeAtRowCol, 1, 2);
    count[2] = conway.countNeighborhood(lifeAtRowCol, 1, 3);
    count[3] = conway.countNeighborhood(lifeAtRowCol, 1, 4);
    count[4] = conway.countNeighborhood(lifeAtRowCol, 2, 3);
    count[5] = conway.countNeighborhood(lifeAtRowCol, 3, 4);
    count[6] = conway.countNeighborhood(lifeAtRowCol, 4, 4);
...
describe("Count neighborhood dblchk", function() {
  it("counts the number of cells alive in the Moore neighborhood", function() {
    ...
    count[0] = conway.countNeighborhood(lifeAtRowCol, 0, 0);
    count[1] = conway.countNeighborhood(lifeAtRowCol, 0, 1);
    count[2] = conway.countNeighborhood(lifeAtRowCol, 0, 2);
    count[3] = conway.countNeighborhood(lifeAtRowCol, 0, 3);
    count[4] = conway.countNeighborhood(lifeAtRowCol, 0, 4);
    count[5] = conway.countNeighborhood(lifeAtRowCol, 1, 0);
    count[6] = conway.countNeighborhood(lifeAtRowCol, 1, 1);
    count[7] = conway.countNeighborhood(lifeAtRowCol, 1, 2);
    count[8] = conway.countNeighborhood(lifeAtRowCol, 1, 3);
    count[9] = conway.countNeighborhood(lifeAtRowCol, 1, 4);
    count[10] = conway.countNeighborhood(lifeAtRowCol, 2, 0);
    count[11] = conway.countNeighborhood(lifeAtRowCol, 2, 1);
    count[12] = conway.countNeighborhood(lifeAtRowCol, 2, 2);
    count[13] = conway.countNeighborhood(lifeAtRowCol, 2, 3);
    count[14] = conway.countNeighborhood(lifeAtRowCol, 2, 4);
    count[15] = conway.countNeighborhood(lifeAtRowCol, 3, 0);
    count[16] = conway.countNeighborhood(lifeAtRowCol, 3, 1);
